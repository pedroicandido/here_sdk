...
class CatalogConfiguration {
  ...
  /// contained in an entirely seperate catalog, called the patch catalog.
  ...
  /// If set to false, the data is not stored in persistant storage and is only reatined in the cache for a limited time (see [CatalogConfiguration.cacheExpirationPeriod]).
  /// Defaults to true.
  bool allowDownload;
