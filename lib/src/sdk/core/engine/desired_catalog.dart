...
class DesiredCatalog {
  ...
  /// catalog to your project. For more inforamtion, see [CatalogIdentifier.hrn]
  ///
  ...
  /// [CatalogVersionHint.latest] to access the latest version of the catalog available on the HERE platform.
  /// Based on the value in this field, the HERE platfrom will determine the best version to use for this catalog
