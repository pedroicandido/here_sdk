...
class SDKOptions {
  ...
  /// default path will be used and the default path is `<Application_Home>/Library/Caches` for iOS and `Context.getCacheDir().getPath()` for Android.
  /// If path is relative then directory
  ...
  /// to the desired location for which the application has read/write permissions.
  /// The path can be on internal or external storage. If it is not set, the
  /// default path will be used and the default path is `Application Library directory` for iOS and `Context.getFilesDir().getPath()` for Android.
  /// If path is relative then directory
  ...
  SDKOptions._(this.accessKeyId, this.accessKeySecret, this.scope, this.cachePath, this.cacheSizeInBytes, this.persistentMapStoragePath, this.politicalView, this._offlineMode, this._layerConfiguration, this._enableMigration, this.catalogConfigurations, this.autoUpdateOfOnlineCache, this.customEngineBaseUrls, this.actionOnCacheLock);
  ...
  bool operator ==(Object other) {
    ...
    return accessKeyId == _other.accessKeyId &&
        ...
        _offlineMode == _other._offlineMode &&
        _layerConfiguration == _other._layerConfiguration &&
        _enableMigration == _other._enableMigration &&
  ...
  int get hashCode {
    ...
    result = 31 * result + _offlineMode.hashCode;
    result = 31 * result + _layerConfiguration.hashCode;
    result = 31 * result + _enableMigration.hashCode;
...
final _sdkCoreEngineSdkoptionsCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Int64, Pointer<Void>, Pointer<Void>, Uint8, Pointer<Void>, Uint8, Pointer<Void>, Uint8, Pointer<Void>, Uint32),
    Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, int, Pointer<Void>, Pointer<Void>, int, Pointer<Void>, int, Pointer<Void>, int, Pointer<Void>, int)
...
Pointer<Void> sdkCoreEngineSdkoptionsToFfi(SDKOptions value) {
  ...
  final _offlineModeHandle = booleanToFfi(value._offlineMode);
  final _layerConfigurationHandle = sdkCoreEngineLayerconfigurationToFfi(value._layerConfiguration);
  final _enableMigrationHandle = booleanToFfi(value._enableMigration);
