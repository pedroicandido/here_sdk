...
final _makeLocationEngineReturnReleaseHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_location_LocationEngineBase_makeLocationEngine__SDKNativeEngine_return_release_handle'));
final _makeLocationEngineReturnGetResult = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_location_LocationEngineBase_makeLocationEngine__SDKNativeEngine_return_get_result'));
final _makeLocationEngineReturnGetError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint32 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_location_LocationEngineBase_makeLocationEngine__SDKNativeEngine_return_get_error'));
final _makeLocationEngineReturnHasError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint8 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_location_LocationEngineBase_makeLocationEngine__SDKNativeEngine_return_has_error'));


final _makeLocationEngineFromSharedSdkNativeEngineReturnReleaseHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_location_LocationEngineBase_makeLocationEngineFromSharedSdkNativeEngine_return_release_handle'));
final _makeLocationEngineFromSharedSdkNativeEngineReturnGetResult = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_location_LocationEngineBase_makeLocationEngineFromSharedSdkNativeEngine_return_get_result'));
final _makeLocationEngineFromSharedSdkNativeEngineReturnGetError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint32 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_location_LocationEngineBase_makeLocationEngineFromSharedSdkNativeEngine_return_get_error'));
final _makeLocationEngineFromSharedSdkNativeEngineReturnHasError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint8 Function(Pointer<Void>),
    int Function(Pointer<Void>)
...
class LocationEngineBase$Impl extends __lib.NativeBase implements LocationEngineBase {
  ...
  LocationEngineBase makeLocationEngine(SDKNativeEngine sdkEngine) {
    ...
    if (_makeLocationEngineReturnHasError(__callResultHandle) != 0) {
        final __errorHandle = _makeLocationEngineReturnGetError(__callResultHandle);
        _makeLocationEngineReturnReleaseHandle(__callResultHandle);
        try {
    ...
    final __resultHandle = _makeLocationEngineReturnGetResult(__callResultHandle);
    _makeLocationEngineReturnReleaseHandle(__callResultHandle);
    try {
  ...
  LocationEngineBase makeLocationEngineFromSharedSdkNativeEngine() {
    ...
    if (_makeLocationEngineFromSharedSdkNativeEngineReturnHasError(__callResultHandle) != 0) {
        final __errorHandle = _makeLocationEngineFromSharedSdkNativeEngineReturnGetError(__callResultHandle);
        _makeLocationEngineFromSharedSdkNativeEngineReturnReleaseHandle(__callResultHandle);
        try {
          throw InstantiationException(sdkCoreErrorsInstantiationerrorcodeFromFfi(__errorHandle));
        } finally {
          sdkCoreErrorsInstantiationerrorcodeReleaseFfiHandle(__errorHandle);
    ...
    final __resultHandle = _makeLocationEngineFromSharedSdkNativeEngineReturnGetResult(__callResultHandle);
    _makeLocationEngineFromSharedSdkNativeEngineReturnReleaseHandle(__callResultHandle);
    try {
      return sdkLocationLocationenginebaseFromFfi(__resultHandle);
    } finally {
