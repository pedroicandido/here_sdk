...
final _getOfflineMapsStorageSizeInBytesReturnReleaseHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_maploader_MapDownloader_getOfflineMapsStorageSizeInBytes_return_release_handle'));
final _getOfflineMapsStorageSizeInBytesReturnGetResult = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint64 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_maploader_MapDownloader_getOfflineMapsStorageSizeInBytes_return_get_result'));
final _getOfflineMapsStorageSizeInBytesReturnGetError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint32 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_maploader_MapDownloader_getOfflineMapsStorageSizeInBytes_return_get_error'));
final _getOfflineMapsStorageSizeInBytesReturnHasError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint8 Function(Pointer<Void>),
    int Function(Pointer<Void>)
...
class MapDownloader$Impl extends __lib.NativeBase implements MapDownloader {
  ...
  int getOfflineMapsStorageSizeInBytes() {
    ...
    if (_getOfflineMapsStorageSizeInBytesReturnHasError(__callResultHandle) != 0) {
        final __errorHandle = _getOfflineMapsStorageSizeInBytesReturnGetError(__callResultHandle);
        _getOfflineMapsStorageSizeInBytesReturnReleaseHandle(__callResultHandle);
        try {
          throw MapLoaderExceptionException(sdkMaploaderMaploadererrorFromFfi(__errorHandle));
        } finally {
          sdkMaploaderMaploadererrorReleaseFfiHandle(__errorHandle);
    ...
    final __resultHandle = _getOfflineMapsStorageSizeInBytesReturnGetResult(__callResultHandle);
    _getOfflineMapsStorageSizeInBytesReturnReleaseHandle(__callResultHandle);
    try {
