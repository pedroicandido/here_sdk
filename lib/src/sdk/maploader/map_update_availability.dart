...
enum MapUpdateAvailability {
    /// Previously downloaded regions or catalog version can be updated to their latest version.
    available,
    /// All previously downloaded regions are up-to-date and catalog version is also up-to-date.
    notAvailable
}
