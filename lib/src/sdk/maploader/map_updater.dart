...
abstract class MapUpdater {
  ...
  /// After completion, it is recommend to call [MapDownloader.getDownloadableRegionsWithLanguageCode] to update the internal
  /// catalog data that is needed to download, update or delete existing `Region` data. It is
  /// required to do this at least once before doing a new download, update or delete operation or
  /// an error will occur.
  ///
