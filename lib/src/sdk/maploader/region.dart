...
class Region {
  ...
  Region.withAllDefaults(this.regionId)
      : _parentId = RegionId(0), name = "", sizeOnDiskInBytes = 0, sizeOnNetworkInBytes = 0, childRegions = null;
  @Deprecated("Will be removed in v4.13.0. Please use Region.withAllDefaults() instead.")
  Region.withDefaults(this.regionId, this._parentId, this.name, this.sizeOnDiskInBytes, this.sizeOnNetworkInBytes)
      : childRegions = null;
  @Deprecated("Will be removed in v4.13.0. Please use Region.withAllDefaults() instead.")
  Region(this.regionId, this._parentId, this.name, this.sizeOnDiskInBytes, this.sizeOnNetworkInBytes, this.childRegions);
  @override
