...
final _fromMeshWithTextureFilePathAndColorReturnReleaseHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapMarker3DModel_make__Mesh_String_Color_return_release_handle'));
final _fromMeshWithTextureFilePathAndColorReturnGetResult = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapMarker3DModel_make__Mesh_String_Color_return_get_result'));
final _fromMeshWithTextureFilePathAndColorReturnGetError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint32 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapMarker3DModel_make__Mesh_String_Color_return_get_error'));
final _fromMeshWithTextureFilePathAndColorReturnHasError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
...
final _fromMeshWithTextureFilePathReturnReleaseHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapMarker3DModel_make__Mesh_String_return_release_handle'));
final _fromMeshWithTextureFilePathReturnGetResult = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapMarker3DModel_make__Mesh_String_return_get_result'));
final _fromMeshWithTextureFilePathReturnGetError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint32 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapMarker3DModel_make__Mesh_String_return_get_error'));
final _fromMeshWithTextureFilePathReturnHasError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint8 Function(Pointer<Void>),
    int Function(Pointer<Void>)
...
class MapMarker3DModel$Impl extends __lib.NativeBase implements MapMarker3DModel {
  ...
  static Pointer<Void> _fromMeshWithTextureFilePathAndColor(Mesh mesh, String textureFilePath, ui.Color color) {
    ...
    stringReleaseFfiHandle(_textureFilePathHandle);
    sdkCoreColorReleaseFfiHandle(_colorHandle);
    if (_fromMeshWithTextureFilePathAndColorReturnHasError(__callResultHandle) != 0) {
        final __errorHandle = _fromMeshWithTextureFilePathAndColorReturnGetError(__callResultHandle);
        _fromMeshWithTextureFilePathAndColorReturnReleaseHandle(__callResultHandle);
        try {
    ...
    final __resultHandle = _fromMeshWithTextureFilePathAndColorReturnGetResult(__callResultHandle);
    _fromMeshWithTextureFilePathAndColorReturnReleaseHandle(__callResultHandle);
    return __resultHandle;
  }
  ...
  static Pointer<Void> _fromMeshWithTextureFilePath(Mesh mesh, String textureFilePath) {
    ...
    sdkMapviewMeshReleaseFfiHandle(_meshHandle);
    stringReleaseFfiHandle(_textureFilePathHandle);
    if (_fromMeshWithTextureFilePathReturnHasError(__callResultHandle) != 0) {
        final __errorHandle = _fromMeshWithTextureFilePathReturnGetError(__callResultHandle);
        _fromMeshWithTextureFilePathReturnReleaseHandle(__callResultHandle);
        try {
          throw MapMarker3DModelInstantiationException(sdkMapviewMapmarker3dmodelInstantiationerrorcodeFromFfi(__errorHandle));
        } finally {
          sdkMapviewMapmarker3dmodelInstantiationerrorcodeReleaseFfiHandle(__errorHandle);
    ...
    final __resultHandle = _fromMeshWithTextureFilePathReturnGetResult(__callResultHandle);
    _fromMeshWithTextureFilePathReturnReleaseHandle(__callResultHandle);
    return __resultHandle;
  }
