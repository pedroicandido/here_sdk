...
class MapMarkerClusterCounterStyle {
  /// Font color of counter, default is white.
  ui.Color textColor;

  /// Font size of counter, default value is 20.
  double fontSize;

  /// Anchor of counter in regards to marker cluster image. Default is in center.
  Anchor2D textAnchor;

  /// Maximal number of markers represented as exact number. Values smaller than 2 will be clamped to 2.
  /// Defaults to 99. When this value is changed, it is recommended to adapt [MapMarkerClusterCounterStyle.aboveMaxText] accordingly.
  int maxCountNumber;

  /// String to display if there are more markers clustered than [MapMarkerClusterCounterStyle.maxCountNumber]. Defaults to "+99".
  String aboveMaxText;
