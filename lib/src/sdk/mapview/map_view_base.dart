...
abstract class MapViewBase {
  ...
  ///
  /// Returns [GeoCoordinates?]. The converted GeoCoordinate or `null` if there is no render
  /// surface attached.
  ///
  ...
  /// covered by any custom marker. The pick area is defined by a rectangle in map view coordinates (in pixels),
  /// relative to the map view's origin at (0, 0) which indicates the top-left corner of the map view.
  ///
  /// Note: Map items that are added by the user can be picked with
  /// [MapViewBase.pickMapItems] instead.
  ///
  /// [viewRectangle] The rectangle inside which the objects should be picked in map view coordinates (in pixels),
  /// relative to the map view's origin at (0, 0) which indicates the top-left corner of the map view.
  ///
  /// [callback] Callback to call with the result. This will be called on main thread when the operation
  /// has completed.
