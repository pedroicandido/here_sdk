...
@Deprecated("Will be removed in v4.15.0. Use [CameraBehavior] instead")
...
class CameraSettings {
  ...
  /// Optional principal point to be used during navigation.
  /// Defaults to (null), which means the camera
  /// will use the position slightly at the bottom of the mapview.
  Point2D? principalPoint;

  CameraSettings._(this.cameraDistanceInMeters, this.cameraTiltInDegrees, this.cameraBearingInDegrees, this.principalPoint);
  CameraSettings.withDefaults()
      : cameraDistanceInMeters = 150.0, cameraTiltInDegrees = 50.0, cameraBearingInDegrees = null, principalPoint = null;
  ...
  bool operator ==(Object other) {
    ...
    return cameraDistanceInMeters == _other.cameraDistanceInMeters &&
        ...
        principalPoint == _other.principalPoint;
  }
  ...
  int get hashCode {
    ...
    result = 31 * result + principalPoint.hashCode;
    return result;
  }
}
...
final _sdkNavigationCamerasettingsCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Double, Double, Pointer<Void>, Pointer<Void>),
    Pointer<Void> Function(double, double, Pointer<Void>, Pointer<Void>)
...
final _sdkNavigationCamerasettingsGetFieldprincipalPoint = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_navigation_CameraSettings_get_field_principalPoint'));
...
Pointer<Void> sdkNavigationCamerasettingsToFfi(CameraSettings value) {
  ...
  final _principalPointHandle = sdkCorePoint2dToFfiNullable(value.principalPoint);
  final _result = _sdkNavigationCamerasettingsCreateHandle(_cameraDistanceInMetersHandle, _cameraTiltInDegreesHandle, _cameraBearingInDegreesHandle, _principalPointHandle);
  
  
  doubleReleaseFfiHandleNullable(_cameraBearingInDegreesHandle);
  sdkCorePoint2dReleaseFfiHandleNullable(_principalPointHandle);
  return _result;
}
...
CameraSettings sdkNavigationCamerasettingsFromFfi(Pointer<Void> handle) {
  ...
  final _principalPointHandle = _sdkNavigationCamerasettingsGetFieldprincipalPoint(handle);
  try {
    return CameraSettings._(
      (_cameraDistanceInMetersHandle), 
      (_cameraTiltInDegreesHandle), 
      doubleFromFfiNullable(_cameraBearingInDegreesHandle), 
      sdkCorePoint2dFromFfiNullable(_principalPointHandle)
    );
  } finally {
