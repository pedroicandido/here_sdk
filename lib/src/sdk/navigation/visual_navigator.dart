...
abstract class VisualNavigator implements NavigatorInterface {
  ...
  ///
  void stopRendering();
  @Deprecated("Will be removed in v4.15.0. Use [VisualNavigator.cameraBehavior] instead. If [VisualNavigator.cameraBehavior] is `null` then camera mode is disabled.")
  ...
  @Deprecated("Will be removed in v4.15.0. Use [VisualNavigator.cameraBehavior] instead")
