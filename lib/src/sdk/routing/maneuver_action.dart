...
enum ManeuverAction {
    ...
    rightFork,
    /// Enter highway from left maneuver, such as "Join the highway from the left side".
    ///
    /// **Note:** This action is only generated for turn-by-turn navigation and it is not
    /// available as part of the `Maneuver` items taken from the `Section` list of a `Route`.
    enterHighwayFromLeft,
    /// Enter highway from right maneuver, such as "Join the highway from the right side".
    ///
    /// **Note:** This action is only generated for turn-by-turn navigation and it is not
    /// available as part of the `Maneuver` items taken from the `Section` list of a `Route`.
