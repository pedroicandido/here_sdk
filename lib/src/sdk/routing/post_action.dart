...
class PostAction {
  ...
  PostAction._(this.action, this.durationInSeconds, this.duration, this.chargingDetails);
  ...
  PostAction(this.action, this.durationInSeconds)
      : duration = const Duration(seconds: 0), chargingDetails = null;
  PostAction.withDefaults()
      : action = PostActionType.chargingSetup, durationInSeconds = 0, duration = const Duration(seconds: 0), chargingDetails = null;
  @override
...
final _sdkRoutingPostactionCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Uint32, Int32, Uint64, Pointer<Void>),
    Pointer<Void> Function(int, int, int, Pointer<Void>)
...
Pointer<Void> sdkRoutingPostactionToFfi(PostAction value) {
  ...
  final _result = _sdkRoutingPostactionCreateHandle(_actionHandle, _durationInSecondsHandle, _durationHandle, _chargingDetailsHandle);
