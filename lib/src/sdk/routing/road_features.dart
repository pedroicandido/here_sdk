...
enum RoadFeatures {
    ...
    @Deprecated("Will be removed in v4.15.0. Use [RoadFeatures.uTurns] instead")
    difficultTurns,
    /// This part of the route has a u-turns. Note that this feature is valid
    /// only for trucks.
    /// NOTE: this road feature is not available in the OFFLINE router and the
    /// [RoadFeatures.difficultTurns] will be used instead.
    uTurns
}
