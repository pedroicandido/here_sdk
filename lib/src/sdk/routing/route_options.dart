...
class RouteOptions {
  ...
  /// A flag that indicates whether the enter highway-related [ManeuverAction] should be generated or not.
  ///
  /// **Note:** These actions are only generated for turn-by-turn navigation and they
  /// are not available as part of the `Maneuver` items taken from the `Section` list of a `Route`.
  ///
  /// Defaults to false.
  @Deprecated("This field will be become unavailable with release 4.15.0 and will then be\nenabled by default.")
  bool enableEnterHighwayManeuverAction;

  RouteOptions([OptimizationMode optimizationMode = OptimizationMode.fastest, int alternatives = 0, DateTime? departureTime = null, DateTime? arrivalTime = null, double? speedCapInMetersPerSecond = null, bool enableRouteHandle = false, bool enableTrafficOptimization = true, bool enableTolls = false, int occupantsNumber = 1, bool optimizeWaypointsOrder = false, bool enableEnterHighwayManeuverAction = false])
    : optimizationMode = optimizationMode, alternatives = alternatives, departureTime = departureTime, arrivalTime = arrivalTime, speedCapInMetersPerSecond = speedCapInMetersPerSecond, enableRouteHandle = enableRouteHandle, enableTrafficOptimization = enableTrafficOptimization, enableTolls = enableTolls, occupantsNumber = occupantsNumber, optimizeWaypointsOrder = optimizeWaypointsOrder, enableEnterHighwayManeuverAction = enableEnterHighwayManeuverAction;
  RouteOptions.withDefaults()
      : optimizationMode = OptimizationMode.fastest, alternatives = 0, departureTime = null, arrivalTime = null, speedCapInMetersPerSecond = null, enableRouteHandle = false, enableTrafficOptimization = true, enableTolls = false, occupantsNumber = 1, optimizeWaypointsOrder = false, enableEnterHighwayManeuverAction = false;
  @override
  bool operator ==(Object other) {
    ...
    return optimizationMode == _other.optimizationMode &&
        ...
        enableEnterHighwayManeuverAction == _other.enableEnterHighwayManeuverAction;
  }
  ...
  int get hashCode {
    ...
    result = 31 * result + enableEnterHighwayManeuverAction.hashCode;
    return result;
  }
}
...
final _sdkRoutingRouteoptionsCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Uint32, Int32, Pointer<Void>, Pointer<Void>, Pointer<Void>, Uint8, Uint8, Uint8, Int32, Uint8, Uint8),
...
final _sdkRoutingRouteoptionsGetFieldenableEnterHighwayManeuverAction = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint8 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_routing_RouteOptions_get_field_enableEnterHighwayManeuverAction'));
...
Pointer<Void> sdkRoutingRouteoptionsToFfi(RouteOptions value) {
  ...
  final _enableEnterHighwayManeuverActionHandle = booleanToFfi(value.enableEnterHighwayManeuverAction);
  final _result = _sdkRoutingRouteoptionsCreateHandle(_optimizationModeHandle, _alternativesHandle, _departureTimeHandle, _arrivalTimeHandle, _speedCapInMetersPerSecondHandle, _enableRouteHandleHandle, _enableTrafficOptimizationHandle, _enableTollsHandle, _occupantsNumberHandle, _optimizeWaypointsOrderHandle, _enableEnterHighwayManeuverActionHandle);
  ...
  booleanReleaseFfiHandle(_enableEnterHighwayManeuverActionHandle);
  return _result;
}
...
RouteOptions sdkRoutingRouteoptionsFromFfi(Pointer<Void> handle) {
  ...
  final _enableEnterHighwayManeuverActionHandle = _sdkRoutingRouteoptionsGetFieldenableEnterHighwayManeuverAction(handle);
  try {
    return RouteOptions(
      ...
      booleanFromFfi(_enableEnterHighwayManeuverActionHandle)
    );
  } finally {
    sdkRoutingOptimizationmodeReleaseFfiHandle(_optimizationModeHandle);
