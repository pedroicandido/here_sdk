...
abstract class RoutingEngine implements RoutingInterface {
  ...
  ///
  /// The custom option is applicable for all queries that `RoutingEngine` performs.
  /// **Note:** It's easy to set a wrong option that makes queries invalid. Be sure that Routing v8 backend supports the option you set.
  ///
