...
class SegmentReference {
  ...
  SegmentReference([String segmentId = "", TravelDirection travelDirection = TravelDirection.bidirectional, double offsetStart = 0.0, double offsetEnd = 1.0, int tilePartitionId = 0, int? localId = 0])
    : segmentId = segmentId, travelDirection = travelDirection, _offsetStart = offsetStart, _offsetEnd = offsetEnd, tilePartitionId = tilePartitionId, localId = localId;
  SegmentReference.withDefaults()
      : segmentId = "", travelDirection = TravelDirection.bidirectional, _offsetStart = 0.0, _offsetEnd = 1.0, tilePartitionId = 0, localId = 0;
  ...
  bool operator ==(Object other) {
    ...
    return segmentId == _other.segmentId &&
        ...
        _offsetStart == _other._offsetStart &&
        _offsetEnd == _other._offsetEnd &&
  ...
  int get hashCode {
    ...
    result = 31 * result + _offsetStart.hashCode;
    result = 31 * result + _offsetEnd.hashCode;
...
Pointer<Void> sdkRoutingSegmentreferenceToFfi(SegmentReference value) {
  ...
  final _offsetStartHandle = (value._offsetStart);
  final _offsetEndHandle = (value._offsetEnd);
