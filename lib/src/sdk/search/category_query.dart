...
class CategoryQuery {
  ...
  /// **Note:** This is a beta release of this feature, so there could be a few bugs and unexpected behaviors.
  /// Related APIs may change for new releases without a deprecation process.
  /// [TruckClass.lightClass] is not accepted in the filter. Otherwise will will result in [SearchError.invalidParameter].
  ...
  CategoryQuery._(this.categories, this.excludeCategories, this.includeChains, this.excludeChains, this.fuelTypes, this.truckFuelTypes, this.truckClass, this.filter, this.area, this.areaCenter, this.boxArea, this.circleArea, this.corridorArea);
...
final _sdkSearchCategoryqueryGetFieldfuelTypes = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_CategoryQuery_get_field_fuelTypes'));
final _sdkSearchCategoryqueryGetFieldtruckFuelTypes = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_CategoryQuery_get_field_truckFuelTypes'));
final _sdkSearchCategoryqueryGetFieldtruckClass = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_CategoryQuery_get_field_truckClass'));
...
Pointer<Void> sdkSearchCategoryqueryToFfi(CategoryQuery value) {
  ...
  final _circleAreaHandle = sdkCoreGeocircleToFfiNullable(value.circleArea);
  final _corridorAreaHandle = sdkCoreGeocorridorToFfiNullable(value.corridorArea);
  final _result = _sdkSearchCategoryqueryCreateHandle(_categoriesHandle, _excludeCategoriesHandle, _includeChainsHandle, _excludeChainsHandle, _fuelTypesHandle, _truckFuelTypesHandle, _truckClassHandle, _filterHandle, _areaHandle, _areaCenterHandle, _boxAreaHandle, _circleAreaHandle, _corridorAreaHandle);
  heresdkSearchCommonBindingslistofSdkSearchPlacecategoryReleaseFfiHandle(_categoriesHandle);
...
CategoryQuery sdkSearchCategoryqueryFromFfi(Pointer<Void> handle) {
  ...
  final _fuelTypesHandle = _sdkSearchCategoryqueryGetFieldfuelTypes(handle);
  final _truckFuelTypesHandle = _sdkSearchCategoryqueryGetFieldtruckFuelTypes(handle);
  final _truckClassHandle = _sdkSearchCategoryqueryGetFieldtruckClass(handle);
