...
class ExtendedAttributeExperimental {
  ...
  EvChargingAttributesExperimental? evStation;

  ExtendedAttributeExperimental(this.evStation);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (other is! ExtendedAttributeExperimental) return false;
    ExtendedAttributeExperimental _other = other;
    return evStation == _other.evStation;
  }

  @override
  int get hashCode {
    int result = 7;
    result = 31 * result + evStation.hashCode;
    return result;
  }
}
...
Pointer<Void> sdkSearchExtendedattributeexperimentalToFfi(ExtendedAttributeExperimental value) {
  final _evStationHandle = sdkSearchEvchargingattributesexperimentalToFfiNullable(value.evStation);
