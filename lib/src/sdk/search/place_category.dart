...
abstract class PlaceCategory {
  ...
  @Deprecated("Will be removed in v4.14.0. Please use `ACCOMMODATION` instead.")
  ...
  @Deprecated("Will be removed in v4.14.0. Please use `ACCOMMODATION_HOTEL_MOTEL` instead.")
  ...
  @Deprecated("Will be removed in v4.14.0. Please use `ACCOMMODATION_LODGING` instead.")
