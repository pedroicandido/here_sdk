...
class PlaceExperimental {
  ...
  int get hashCode {
    int result = 7;
    result = 31 * result + ontologyId.hashCode;
...
Pointer<Void> sdkSearchPlaceexperimentalToFfi(PlaceExperimental value) {
  final _ontologyIdHandle = stringToFfiNullable(value.ontologyId);
  final _extendedHandle = sdkSearchExtendedattributeexperimentalToFfiNullable(value.extended);
