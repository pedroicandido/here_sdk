...
class SuggestionExperimental {
  ...
  SuggestionExperimental._(this.dummy);
  ...
  bool operator ==(Object other) {
    ...
    return dummy == _other.dummy;
  }

  @override
  int get hashCode {
    int result = 7;
    result = 31 * result + dummy.hashCode;
    return result;
  }
}
...
Pointer<Void> sdkSearchSuggestionexperimentalToFfi(SuggestionExperimental value) {
  final _dummyHandle = (value.dummy);
...
SuggestionExperimental sdkSearchSuggestionexperimentalFromFfi(Pointer<Void> handle) {
  ...
  try {
    return SuggestionExperimental._(
      (_dummyHandle)
    );
  } finally {
