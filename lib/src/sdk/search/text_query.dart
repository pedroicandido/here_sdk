...
class TextQuery {
  ...
  /// It is possible to mix `TextQuery.includeChains` with `TextQuery.excludeChains`
  /// - e.g. searching for places that are amazon but not wholefoods.
  ///   An exclusion will always win over an inclusion.
  @Deprecated("Will be removed in v4.15.0. Please use `CategoryQuery.includeChains` instead.")
  ...
  /// **Note:** This is a beta release of this feature, so there could be a few bugs and unexpected behaviors.
  /// Related APIs may change for new releases without a deprecation process.
  /// [TruckClass.lightClass] is not accepted in the filter. Otherwise will result in [SearchError.invalidParameter].
  TruckClass? truckClass;

  TextQuery._(this.query, this.area, this.areaCenter, this.countries, this.boxArea, this.circleArea, this.corridorArea, this.includeChains, this.excludeChains, this.fuelTypes, this.truckFuelTypes, this.truckClass);
  ...
  bool operator ==(Object other) {
    ...
    return query == _other.query &&
        ...
        DeepCollectionEquality().equals(fuelTypes, _other.fuelTypes) &&
...
final _sdkSearchTextqueryGetFieldincludeChains = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_TextQuery_get_field_includeChains'));
final _sdkSearchTextqueryGetFieldexcludeChains = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_TextQuery_get_field_excludeChains'));
final _sdkSearchTextqueryGetFieldfuelTypes = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_TextQuery_get_field_fuelTypes'));
final _sdkSearchTextqueryGetFieldtruckFuelTypes = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_TextQuery_get_field_truckFuelTypes'));
final _sdkSearchTextqueryGetFieldtruckClass = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_TextQuery_get_field_truckClass'));
...
Pointer<Void> sdkSearchTextqueryToFfi(TextQuery value) {
  ...
  final _result = _sdkSearchTextqueryCreateHandle(_queryHandle, _areaHandle, _areaCenterHandle, _countriesHandle, _boxAreaHandle, _circleAreaHandle, _corridorAreaHandle, _includeChainsHandle, _excludeChainsHandle, _fuelTypesHandle, _truckFuelTypesHandle, _truckClassHandle);
  stringReleaseFfiHandle(_queryHandle);
  sdkSearchTextqueryAreaReleaseFfiHandle(_areaHandle);
  sdkCoreGeocoordinatesReleaseFfiHandleNullable(_areaCenterHandle);
  heresdkSearchCommonBindingslistofSdkCoreCountrycodeReleaseFfiHandle(_countriesHandle);
...
TextQuery sdkSearchTextqueryFromFfi(Pointer<Void> handle) {
  ...
  final _includeChainsHandle = _sdkSearchTextqueryGetFieldincludeChains(handle);
  final _excludeChainsHandle = _sdkSearchTextqueryGetFieldexcludeChains(handle);
  final _fuelTypesHandle = _sdkSearchTextqueryGetFieldfuelTypes(handle);
  final _truckFuelTypesHandle = _sdkSearchTextqueryGetFieldtruckFuelTypes(handle);
  final _truckClassHandle = _sdkSearchTextqueryGetFieldtruckClass(handle);
  try {
    return TextQuery._(
