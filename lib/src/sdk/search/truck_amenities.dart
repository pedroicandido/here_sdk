...
/// except shower_count - exact amount of showers, if present.
///
...
class TruckAmenities {
  ...
  /// Shower count, zero by default, non-zero if data is present
  int showerCount;

  TruckAmenities._(this.hasParking, this.hasSecureParking, this.hasCarWash, this.hasTruckWash, this.hasHighCanopy, this.hasIdleReductionSystem, this.hasTruckScales, this.hasPowerSupply, this.hasChemicalToiletDisposal, this.hasTruckStop, this.hasWifi, this.hasTruckService, this.showerCount);
  TruckAmenities()
    : hasParking = false, hasSecureParking = false, hasCarWash = false, hasTruckWash = false, hasHighCanopy = false, hasIdleReductionSystem = false, hasTruckScales = false, hasPowerSupply = false, hasChemicalToiletDisposal = false, hasTruckStop = false, hasWifi = false, hasTruckService = false, showerCount = 0;
  @override
...
final _sdkSearchTruckamenitiesCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Uint8, Uint8, Uint8, Uint8, Uint8, Uint8, Uint8, Uint8, Uint8, Uint8, Uint8, Uint8, Int32),
    Pointer<Void> Function(int, int, int, int, int, int, int, int, int, int, int, int, int)
...
Pointer<Void> sdkSearchTruckamenitiesToFfi(TruckAmenities value) {
  ...
  final _showerCountHandle = (value.showerCount);
  final _result = _sdkSearchTruckamenitiesCreateHandle(_hasParkingHandle, _hasSecureParkingHandle, _hasCarWashHandle, _hasTruckWashHandle, _hasHighCanopyHandle, _hasIdleReductionSystemHandle, _hasTruckScalesHandle, _hasPowerSupplyHandle, _hasChemicalToiletDisposalHandle, _hasTruckStopHandle, _hasWifiHandle, _hasTruckServiceHandle, _showerCountHandle);
