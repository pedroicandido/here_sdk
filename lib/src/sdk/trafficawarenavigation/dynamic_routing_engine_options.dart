...
///
/// When at least one check passes: the [DynamicRoutingListener] is notified.
/// When at least one has a value of 0: on each new calculation the [DynamicRoutingListener] is notified.
...
class DynamicRoutingEngineOptions {
  ...
  /// A value of 0 will notify the [DynamicRoutingListener] with each calculated route.
  /// Defauts to `null`.
  ...
  /// [minTimeDifferenceInSeconds] The minimum time difference, before notifying the [DynamicRoutingListener].
  /// To get notified, the following check must be true:
  /// oldEstimatedTimeOfArrival - newEstimatedTimeOfArrival > [DynamicRoutingEngineOptions.minTimeDifferenceInSeconds].
  /// A value of 0 will notify the [DynamicRoutingListener] with each calculated route.
  /// Defauts to `null`.
